...
const Sidebar = ({duckColors, theme, setTheme, time, setTime, tubeColors, waveColors, wavePhysics, setWavePhysics}: SidebarProps): React.ReactElement => {
    ...
    <div className='sidebar'>
      ...
      <section className="sidebar__section">
        ...
        <div className="grid grid--sidebar">
          {inputs['theme-base'].concat({base: theme['custom-base'], supplement: 'custom'}).map(({base, supplement}, i) => {
            return (
