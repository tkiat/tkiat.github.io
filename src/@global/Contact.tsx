...
const Contact = ({navMainIndex}: Prop): React.ReactElement => {
  ...
  return (
    <div className='contact'>
      ...
      <p className='contact__paragraph'><span role='img' aria-hidden='true'>{'\u{2709}'}</span> tkiat@tutanota.com <span role='img' aria-hidden='true'>{'\u{260E}'}</span> (+66)646468180</p>
